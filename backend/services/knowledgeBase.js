/**
 * StatSamarth AI - Official MoSPI Statistical Manual Chunks
 * Pre-indexed text chunks extracted from official Ministry publications.
 */

const MOSPI_OFFICIAL_CHUNKS = [
  // CPI Base 2012 Methodology Manual Chunks
  {
    id: 'cpi_chk_01',
